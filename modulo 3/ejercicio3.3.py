...
def resolver_eoq(D, S, H, C, dias_laborables, lead_time):
    ...
    print("=== Universidad Cuauhtémoc - Ejercicio 3.3 ===")
...
# ==========================================
# Parámetros exactos del Ejercicio 3.3
# ==========================================
D = 10000      # Demanda anual (unidades/año)
S = 150        # Costo de ordenar (USD/orden)
H = 3          # Costo de mantener en inventario (USD/unidad/año)
C = 25         # Costo unitario del producto (USD/unidad)
dias_lab = 250 # Días laborables al año
L = 5          # Tiempo de espera / Lead Time (días)
...
plt.title('Simulación de Inventario: Modelo EOQ - Ejercicio 3.3')
